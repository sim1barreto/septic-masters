    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div>
                <div className="text-white text-lg tracking-tight leading-none" style={{ fontWeight: 800 }}>
                  SEPTIC MASTERS
                </div>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              >
                ...
                <span style={{ fontWeight: 600 }}>(555) 123-4567</span>
              </a>
              <Link
                to="/contact"
                className="px-5 py-2.5 rounded-xl bg-[#BE2026] hover:bg-[#A0181F] text-white text-sm shadow-lg shadow-red-900/30 hover:scale-105 transition-all duration-200"
            ...
            >
              <div className="px-4 pt-4 pb-6 space-y-1">
                ...
                <div className="pt-4 space-y-3">
                  <a
                    href="tel:+15551234567"
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-white/10 text-white"
                  ...
                  <Link
                    to="/contact"
                    className="block text-center py-3 rounded-xl bg-[#BE2026] text-white hover:bg-[#A0181F] transition-colors"
                    style={{ fontWeight: 700 }}
                  >
                    Get Free Quote
                  </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden safe-area-bottom">
        <div className="flex">
          <a
            href="tel:+15551234567"
            className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#1E7A45] text-white"
            style={{ fontWeight: 700 }}
          >
          ...
          <Link
            to="/contact"
            className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#BE2026] text-white"
            style={{ fontWeight: 700 }}
          >
